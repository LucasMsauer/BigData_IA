    ...
    if new_case:
        ...
        with st.spinner("Classificando..."):
            ...
            messages = [
                ...
                ChatMessage(
                    role="user",
                    content="Com base nos casos similares, forneça a classificação de risco (vermelha, laranja, amarela, verde ou azul),Diagnóstico mais provável (CID-10 Capítulo VII: H00-H59), justifique essa classificação e sugira condutas iniciais. Não inclua informações irrelevantes ou fora do contexto clínico."
                ),
            ]
